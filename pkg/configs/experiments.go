...
import (
	...
	"github.com/Eitol/terraform-internals/pkg/experiments"
...
//
// go install -ldflags="-X 'github.com/Eitol/terraform-internals/pkg/configs.disableExperimentWarnings=yes'"
//
