...
import (
	...
	backendLocal "github.com/Eitol/terraform-internals/pkg/backend/local"
	backendRemote "github.com/Eitol/terraform-internals/pkg/backend/remote"
	backendArtifactory "github.com/Eitol/terraform-internals/pkg/backend/remote-state/artifactory"
	backendAzure "github.com/Eitol/terraform-internals/pkg/backend/remote-state/azure"
	backendConsul "github.com/Eitol/terraform-internals/pkg/backend/remote-state/consul"
	backendCos "github.com/Eitol/terraform-internals/pkg/backend/remote-state/cos"
	backendEtcdv2 "github.com/Eitol/terraform-internals/pkg/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/Eitol/terraform-internals/pkg/backend/remote-state/etcdv3"
	backendGCS "github.com/Eitol/terraform-internals/pkg/backend/remote-state/gcs"
	backendHTTP "github.com/Eitol/terraform-internals/pkg/backend/remote-state/http"
	backendInmem "github.com/Eitol/terraform-internals/pkg/backend/remote-state/inmem"
	backendKubernetes "github.com/Eitol/terraform-internals/pkg/backend/remote-state/kubernetes"
	backendManta "github.com/Eitol/terraform-internals/pkg/backend/remote-state/manta"
	backendOSS "github.com/Eitol/terraform-internals/pkg/backend/remote-state/oss"
	backendPg "github.com/Eitol/terraform-internals/pkg/backend/remote-state/pg"
	backendS3 "github.com/Eitol/terraform-internals/pkg/backend/remote-state/s3"
	backendSwift "github.com/Eitol/terraform-internals/pkg/backend/remote-state/swift"
)
