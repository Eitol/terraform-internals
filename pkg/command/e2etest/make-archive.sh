...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "-X github.com/Eitol/terraform-internals/pkg/command/e2etest.terraformBin=./terraform$GOEXE" github.com/Eitol/terraform-internals/pkg/command/e2etest
