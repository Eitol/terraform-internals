...
import (
	...
	fileprovisioner "github.com/Eitol/terraform-internals/pkg/builtin/provisioners/file"
	localexec "github.com/Eitol/terraform-internals/pkg/builtin/provisioners/local-exec"
	remoteexec "github.com/Eitol/terraform-internals/pkg/builtin/provisioners/remote-exec"
	"github.com/Eitol/terraform-internals/pkg/logging"
	tfplugin "github.com/Eitol/terraform-internals/pkg/plugin"
	"github.com/Eitol/terraform-internals/pkg/plugin/discovery"
