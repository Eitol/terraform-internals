...
import (
	...
	"github.com/Eitol/terraform-internals/pkg/command/cliconfig"
	oauthserver "github.com/Eitol/terraform-internals/pkg/command/testdata/login-oauth-server"
	tfeserver "github.com/Eitol/terraform-internals/pkg/command/testdata/login-tfe-server"
	"github.com/Eitol/terraform-internals/pkg/command/webbrowser"
	"github.com/Eitol/terraform-internals/pkg/httpclient"
